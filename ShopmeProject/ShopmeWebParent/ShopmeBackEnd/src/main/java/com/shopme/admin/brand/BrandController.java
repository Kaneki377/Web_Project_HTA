...
public class BrandController {
	...
	public String saveBrand(Brand brand, @RequestParam("fileImage") MultipartFile multipartFile,
					RedirectAttributes ra) throws BrandNotFoundException, IOException {
		if(!multipartFile.isEmpty()) {
			...
			Brand existingBrand = brandService.get(brand.getId());
	...
	public String deleteBrand(@PathVariable(name = "id") Integer id, Model model,
		...
		try {
			...
			ra.addFlashAttribute("message", "The brand ID " +
