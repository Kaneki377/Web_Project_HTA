...
public class OrderController {
	...
	public String saveOrder(Order order, HttpServletRequest request, RedirectAttributes ra) {	
		...
		System.out.println("OrderTrack: " + order.getOrderTracks().getFirst());
	...
	private void updateProductDetails(Order order, HttpServletRequest request) {
		...
		for(int i = 0; i < detailIds.length; i++) {
			...
			System.out.println("\t Products ID: " + productIds[i]);
			System.out.println("\t Products Cost: " + productCosts[i]);
			System.out.println("\t Products PRice: " + productPrices[i]);
			System.out.println("\t Quantities: " + quantities[i]);
			System.out.println("\t Subtotal: " + productSubtotals[i]);
			System.out.println("\t Shipcosts: " + productShipCosts[i]);
