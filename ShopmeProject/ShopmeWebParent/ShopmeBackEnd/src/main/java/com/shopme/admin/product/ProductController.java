...
public class ProductController {
	...
	public String saveProduct(Product product, RedirectAttributes ra, 
		...
		if(!loggedUser.hasRole("Admin") && !loggedUser.hasRole("Edtior")) {
	...
	public String updateProductEnabledStatus(@PathVariable("id") Integer id, @PathVariable("status") boolean enabled, RedirectAttributes ra) {
