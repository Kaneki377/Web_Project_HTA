...
public class UserController {
	...
	//Save infor user vào db
	@PostMapping("/users/save")
	public String saveUser(User user, RedirectAttributes redirectAttributes,
							@RequestParam(name = "image") MultipartFile multipartFile ) throws IOException, UserNotFoundException {
		if (!multipartFile.isEmpty()) {
			...
			// Only update user if image is not uploaded again
	        if (user.getId() != null) {
	            User existingUser = service.get(user.getId());
	            user.setPhotos(existingUser.getPhotos());
	        } else {
	            // If creating new user and no image uploaded, set photos to null
